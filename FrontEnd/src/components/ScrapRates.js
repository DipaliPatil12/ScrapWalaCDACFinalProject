...
export class ScrapRates extends Component {
    render() {
        ...
        <div className="col-3">
             ...
             <center><h4>Printer</h4></center>
                ...
                <img src={printer} style={{width:"150px",height:"150px"}} />
                      ...
                      {/* <h5 class="card-title">Plastic</h5> */}
                      <center><p class="card-text"><b>Rs.100.0/KG</b></p></center>
              </div>
          </Container>
          </div>
     </div>
        ...
        <div className="col-3">
                ...
                <center><h4>Ceiling Fan</h4></center>
                   ...
                   <img src={fan} style={{width:"150px",height:"150px"}} />
                         ...
                         {/* <h5 class="card-title">Plastic</h5> */}
                         <center><p class="card-text"><b>Rs.70.00/KG</b></p></center>
                </div>
                 </Container>
             </div>
        </div>
        ...
        <div className="col-3">
                ...
                <center><h4>Lamp</h4></center>
                   ...
                   <img src={lamp} style={{width:"150px",height:"150px"}} />
                         ...
                         {/* <h5 class="card-title">Plastic</h5> */}
                         <center><p class="card-text"><b>Rs.34.00/KG</b></p></center>
                </div>
                 </Container>
             </div>
        </div>
        <div className="col-3">
                ...
                <center><h4>UPS</h4></center>
                   ...
                   <img src={ups} style={{width:"150px",height:"150px"}} />
                         ...
                         {/* <h5 class="card-title">Plastic</h5> */}
                         <center><p class="card-text"><b>Rs.44.00/KG</b></p></center>
                </div>
                 </Container>
             </div>
        </div>
        <div className="col-3">
                ...
                <center><h4>Fridge(double)</h4></center>
                   ...
                   <img src={fri} style={{width:"150px",height:"150px"}} />
                         ...
                         {/* <h5 class="card-title">Plastic</h5> */}
                         <center><p class="card-text"><b>Rs.140.0/KG</b></p></center>
                </div>
                 </Container>
             </div>
        </div>
      ...
      <div className="col-3">
                     ...
                     <div className="card border border-success" >
              <Container>
              <center><h4>Washing Machine</h4></center>
                   <div class="card-body">
                   <div className="card-image">
